...
export function PersonalGoals() {
  return (
    <div className="bg-white rounded-2xl p-5 md:p-6 shadow-sm border border-gray-100 mb-6 lg:sticky lg:top-20 lg:self-start hover:shadow-md transition-shadow duration-300">
