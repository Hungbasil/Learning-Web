      ...
      <div className="max-w-7xl mx-auto px-3 md:px-6 py-6 md:py-8">
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-3xl font-bold text-gray-800">Duyệt Lộ Trình</h1>
          </div>
          <p className="text-gray-600 mt-2">Chọn lộ trình học tập phù hợp với kỹ năng của bạn</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {[1, 2, 3, 4, 5, 6].map((item) => (
            ...
            >
              ...
              <h3 className="text-lg font-bold text-gray-800 mb-2">Lộ trình {item}</h3>
              <p className="text-sm text-gray-600 mb-4">Mô tả lộ trình học tập toàn diện</p>
